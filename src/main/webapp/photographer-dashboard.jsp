...
<%
    ...
    if (sess == null || !"photographer".equals(sess.getAttribute("role"))) {
...
<head>
    <meta charset="UTF-8">
    <title><%= role.toUpperCase() %> PANEL — Noah Studio</title>
...
<body style="background: var(--bg-primary);">
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            ...
            <div class="stat-grid">
                <div class="stat-card"><h4>Assigned Jobs</h4><div class="val"><%= myJobs.size() %></div></div>
                <div class="stat-card"><h4>Pending Action</h4><div class="val"><%= pendingJobs %></div></div>
                <div class="stat-card"><h4>Portfolio Items</h4><div class="val"><%= myGallery.size() %></div></div>
                <div class="stat-card"><h4>Rating</h4><div class="val"><%= String.format("%.1f", avgRating) %> <i class="fa fa-star" style="font-size: 1rem;"></i></div></div>
            </div>
            
            <div class="card">
                <h3 style="margin-bottom: 2rem;">Upcoming Schedule</h3>
                <% if (myJobs.isEmpty()) { %>
                    <p style="color:var(--text-muted)">No upcoming assignments found.</p>
                <% } else { %>
